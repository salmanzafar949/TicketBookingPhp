		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				<ul class="radius-top clearfix" id="main-menu">
                    ...
                    <li>
						<a href="staff.php">
							<img alt="Statistics" src="img/m-staff.png">
							<span>Staff</span>
						</a>
					</li>
...
<div class="clearfix"></div>
				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> Designation </th>
								<th> Firstname </th>
                                <th> Lastname </th>
							...
							while($row = mysqli_fetch_array($result))
								{
									...
									echo '<td style="border-left: 1px solid #C1DAD7;">'.$row['sf_name'].'</td>';
									echo '<td><div align="right">'.$row['sfl_name'].'</div></td>';
									echo '<td><div align="right">'.$row['sf_address'].'</div></td>';
									echo '<td><div align="right">'.$row['sf_contact'].'</div></td>';
									$rrad=$row['bus'];
				...
				<div id="footer" class="radius-bottom">
					<?php echo"2015"; ?> ©
					<a class="afooter-link" href="">Admin Panel</a>
					by
					<a class="afooter-link" href="">VU Student</a>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
