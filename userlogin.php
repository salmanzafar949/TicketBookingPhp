...
<div id="wrapper">
             ...
             <!-- <ul>
			  ...
			  <div id="penduliom" style=" ">
					...
					<h2 class="accordion-header" >User Login</h2>
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="welcome.php" method="post"  style="margin-bottom:none;">
						<span>Username:</span> <input type="text" name="username"/>
						<span>Password: </span><input type="password" name="pass" />
						<input type="submit" id="submit" name="submit" class="medium gray button" value="Login"  />
						</form>
                        </div>
				</div>
