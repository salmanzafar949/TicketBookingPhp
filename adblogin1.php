             ...
             <!-- <ul>
			  ...
			  <div id="penduliom" style=" ">
					...
					while($row = mysqli_fetch_assoc($res))
					{
						...
						echo $row['type'].'</td><td>';
						echo $row['time'].'</td><td>';
						echo "<a href=\"student1.php?id=".$row['id']."\"><input type=\"button\" value=\"modify\"></a>
						</td><</tr>";
					...
					<div class="accordion-content" style="margin-bottom: 25px;">

<!--
						<span>Date: </span>
						<input type="date" class="w8em format-d-m-y highlight-days-67 range-low-today" name="date" id="sd" value="" maxlength="10" readonly="readonly" />
					...
					<!--<h2 class="accordion-header" >Admin Login</h2>
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<input type="submit" id="submit" class="medium gray button" value="Login"  />
						</form>
                        </div>
				</div>
                ----->
