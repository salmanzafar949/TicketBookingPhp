...
<body>
    <header>
        <div class="container-fluid">
            ...
            <div class="online-book col-md-2 col-sm-2 col-xs-12">
                <a href="contact.php">Book Here</a>
            </div>
        </div>
    </header>
             ...
             <!-- <ul>
			  ...
			  <div id="penduliom" style=" ">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<span>First Name:</span> <input type="text" name="username"/>
                        <span>Last Name:</span> <input type="text" name="username"/>
                        <span>Username:</span> <input type="text" name="username"/>
						<span>Email:</span> <input type="text" name="username"/>
                        <span>Mobile No:</span> <input type="text" name="username"/>
                        <span>Password: </span><input type="password" name="password" />
						<input type="submit" id="submit" class="medium gray button" value="Sign Up"  />
						</form>
                        </div>
				</div>
